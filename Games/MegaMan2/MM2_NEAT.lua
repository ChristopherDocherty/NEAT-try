...
--Put the name of your chosen savestate here
name_for_save = "MetalManBoss"
Filename = "save_states\\" .. name_for_save .. ".state"
ButtonNames = {
		"A",
		"B",
		"Left",
...
function saveGenome(genome, generation, speciesNum, genomeNum)
  ...
  local filename = "genomes\\" .. name_for_save .. "-gen" .. tostring(generation) .. "-species-" .. tostring(speciesNum) .. "-genome-" .. tostring(genomeNum) .. ".gen"
...
function saveGen()
  ...
  local filename = "generation\\" .. name_for_save .. "-Generation-" .. gen.number .. "-Save.gen"
